#include<stdio.h>
#include<string.h>
char keyword[32][10]= { "auto","double","int","break","else","long", "lswitch","case", 				"enum", "register", "typedef","char", "extern", "return", "union", "const", 				"float", "short",  "unsigned","continue","for","signed","void","default", 				"goto", "sizeof", "volatile", "do","if","static","while"} ;
